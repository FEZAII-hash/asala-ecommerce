...
const CartPage: React.FC = () => {
  ...
  const isFreeShipping = cartTotal >= freeShippingThreshold || cartTotal === 0;
  ...
  const handleApplyPromo = (e: React.FormEvent) => {
    ...
    if (!success) {
      setPromoError("Code promotionnel non valide. Essayez « ASALA10 » (-10%) ou « BIENVENUE » (-15%)");
    } else {
      setInputCode("");
    }
  };
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              {/* Free shipping progress gauge */}
              <div className="border border-black/15 p-4 bg-[#faf9f6]">
                <div className="flex justify-between text-[11px] font-medium text-black mb-1.5">
                  {remainingForFreeShipping > 0 ? (
                    <span>
                      Plus que <strong className="font-semibold">{remainingForFreeShipping} TND</strong> pour bénéficier de la livraison offerte en Tunisie.
                    </span>
                  ) : (
                    <span>✓ Félicitations ! Vous bénéficiez de la livraison offerte en Tunisie.</span>
                  )}
                ...
                <div className="mb-6 pb-6 border-b border-black/10">
                  ...
                  {promoCode ? (
                    ...
                    <form onSubmit={handleApplyPromo} className="flex gap-2">
                      ...
                      <button
                        type="submit"
                        className="asala-btn shrink-0 px-3 sm:px-4 py-2 sm:py-2.5"
                      >
                        Appliquer
                      </button>
                    </form>
                ...
                <div className="space-y-3 text-[13px] pb-6 border-b border-black/10">
                  ...
                  <div className="flex justify-between text-stone font-normal">
                    ...
                    <span className="text-black font-medium">
                      {isFreeShipping ? "Gratuite" : `${shippingFee} TND`}
                    </span>
                  </div>
                </div>
