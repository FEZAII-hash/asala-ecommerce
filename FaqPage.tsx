...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Oui, la livraison standard est offerte partout en Tunisie dès 400 TND d'achats. Pour les paniers inférieurs à ce montant, des frais de livraison de 15 TND sont appliqués.",
  },
  {
