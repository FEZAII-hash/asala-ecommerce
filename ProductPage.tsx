            ...
            <div className="flex items-center gap-4 mb-7">
              ...
              {product.stock <= 5 && (
                <span className="text-[11px] text-stone">
                  Plus que {product.stock} pièces en stock
                </span>
              )}
            </div>
            ...
            <div className="border-t border-black/10">
              ...
              >
                <p className="text-[13px] text-stone leading-relaxed">
                  Livraison offerte pour toute commande à partir de 400 TND. Expédition soignée dans son coffret protecteur ASALA. Délais moyens : 24 à 48h sur le Grand Tunis, 48 à 72h sur le reste du pays.
                </p>
              </Accordion>
